...
## Skills
Apply when performing this role: **`spec-handoff`** (end every phase). Read REQ/ARCH via **`spec-req-author`** / **`spec-arch-author`** templates if specs are missing sections.
