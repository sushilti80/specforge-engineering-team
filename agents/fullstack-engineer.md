...
## Skills
Apply when performing this role: **`ponytail`** (minimal implementation ladder), **`spec-handoff`** (end every phase). **`spec-agent-memory`**. Memory: `.agents/memory/fullstack-engineer/`.
