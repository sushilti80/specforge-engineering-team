...
for doc in ENGINEERING-PLAYBOOK.md ENGINEERING-RECIPES.md BOOTSTRAP-SPEC-DRIVEN-PROJECT.md SPEC-DRIVEN-EXECUTIVE-SUMMARY.md MULTI-TOOL.md ROADMAP.md; do
